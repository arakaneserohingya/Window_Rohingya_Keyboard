...
static const uint32_t KEY_MAP[256][2] = {
    ...
    ['Q'] = {0x10D08, 0},        /* Q -> 𐴈 (KHA) */
    ['R'] = {0x10D0C, 0},        /* R -> 𐴌 (RA) */
    ['S'] = {0x10D0F, 0x10D25},  /* S -> 𐴏 (SA), Shift+S -> 𐴥 (Tahala) */
    ['T'] = {0x10D04, 0},        /* T -> 𐴄 (TA) */
    ['U'] = {0x10D1F, 0},        /* U -> 𐴟 (U) */
    ['V'] = {0x10D1D, 0},        /* V -> 𐴝 (VA) */
    ['W'] = {0x10D16, 0x10D27},  /* W -> 𐴖 (WA), Shift+W -> 𐴧 (Tassi) */
    ['X'] = {0x10D1A, 0},        /* X -> 𐴚 (NGA) */
    ['Y'] = {0x10D18, 0x10D24},  /* Y -> 𐴘 (YA), Shift+Y -> 𐴤 (Harbai) */
    ['Z'] = {0x10D0E, 0},        /* Z -> 𐴎 (ZA) */
    ...
    [0xC0] = {0x10D22, 0x10D26}, /* ` -> 𐴢 (Sakin), Shift+` -> 𐴦 (Tana) */
